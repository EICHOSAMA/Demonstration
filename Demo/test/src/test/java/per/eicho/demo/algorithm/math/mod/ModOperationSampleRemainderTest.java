...
public class ModOperationSampleRemainderTest {
    
    private int dividend;
    private int divisor;
    private int expected;
    
    public ModOperationSampleRemainderTest(int dividend, int divisor, int expected) {
    ...
    public void testRemainder() {
        assertThat(ModOperationSample.remainder(dividend, divisor), is(expected));
    }
}
